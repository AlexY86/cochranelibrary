...
public class TopicBuilder {
        ...
        private void build() throws MalformedURLException {
                ...
                allergyIntolerance.setUrl(new URL(
                ...
                complementaryAndAlternativeMedicine.setUrl(new URL(
                ...
                consumerAndCommunicationStrategies.setUrl(new URL(
